...
class ListYnshangjiSpider(CompanySpider):
    name = "ynshangji"
    allowed_domains = ["ynshangji.com"]
    start_urls = ["http://www.ynshangji.com/shen-huangye/"]
    ...
    def parse(self, response):
        ...
        sel_list = response.xpath("//div[@class='til']/a")
        if not sel_list:
        ...
        href = response.xpath("//div[contains(@class,'paging')]/a[text()='下一页']/@href").extract_first()
        if href:
            url = urljoin(href)
